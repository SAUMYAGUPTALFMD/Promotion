...
list_of_files = glob.glob('C:\\Users\\anand\\Desktop\\Journals\\*.pdf') # * means all if need specific format then *.csv
...
company = open("C:\\Users\\anand\\Desktop\\Promo\\Journal\\company.txt","a+")
lis =[]
