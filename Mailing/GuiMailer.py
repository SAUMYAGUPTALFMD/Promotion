...
window = sg.Window("Send unlimited emails!", icon='C:\\Users\\anand\\Desktop\\Promo\\Mailing\\logo.ico').Layout(layout).Finalize()
window.Maximize()
...
while True:
	...
	if event == "Send":
		try:
			emailsList = open("C:\\Users\\anand\\Desktop\\Promo\\Mailing\\Mailing.txt", "r")
			...
			# wb = xl.load_workbook(r'C:\Users\anand\Desktop\Promo\Mailing\mail.xlsx')
			# sheet1 = wb.get_sheet_by_name('Worksheet')

			emailText = open("C:\\Users\\anand\\Desktop\\Promo\\Mailing\\"+values[3], "r+")
